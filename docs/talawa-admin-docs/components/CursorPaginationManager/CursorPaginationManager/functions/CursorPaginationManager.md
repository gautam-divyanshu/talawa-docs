...
Defined in: [components/CursorPaginationManager/CursorPaginationManager.tsx:128](https://github.com/PalisadoesFoundation/talawa-admin/blob/6fc3485a4facf0986d54647cd149412b30c0b289/src/components/CursorPaginationManager/CursorPaginationManager.tsx#L128)
...
`InterfaceCursorPaginationManagerProps`\<`TData`, `TNode`, `TVariables`\>
