...
Defined in: [components/CursorPaginationManager/CursorPaginationManager.tsx:127](https://github.com/PalisadoesFoundation/talawa-admin/blob/8fd8f00df0a90979db5fffb62c8c8045329d3776/src/components/CursorPaginationManager/CursorPaginationManager.tsx#L127)
...
`InterfaceCursorPaginationManagerProps`\<`TNode`, `TVariables`\>
