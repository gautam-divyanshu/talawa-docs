...
# components/Advertisements/AdvertisementsMocks
...
- [createAdvertisementWithoutName](variables/createAdvertisementWithoutName.md)
- [createDates](variables/createDates.md)
- [dateConstants](variables/dateConstants.md)
- [deleteAdvertisementMocks](variables/deleteAdvertisementMocks.md)
- [emptyMocks](variables/emptyMocks.md)
- [fetchErrorMocks](variables/fetchErrorMocks.md)
- [filterActiveAdvertisementData](variables/filterActiveAdvertisementData.md)
