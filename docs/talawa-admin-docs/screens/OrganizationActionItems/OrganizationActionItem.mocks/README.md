...
- [actionItemListQuery](variables/actionItemListQuery.md)
- [actionItemListQueryError](variables/actionItemListQueryError.md)
...
- [itemWithoutAssignee](variables/itemWithoutAssignee.md)
- [itemWithoutCategory](variables/itemWithoutCategory.md)
- [itemWithUser1](variables/itemWithUser1.md)
- [itemWithUser2](variables/itemWithUser2.md)
- [itemWithVolunteerGroup](variables/itemWithVolunteerGroup.md)
- [markActionAsPendingForInstanceMutation](variables/markActionAsPendingForInstanceMutation.md)
- [markActionAsPendingForInstanceMutationError](variables/markActionAsPendingForInstanceMutationError.md)
- [markActionItemAsPendingMutation](variables/markActionItemAsPendingMutation.md)
- [markActionItemAsPendingMutationError](variables/markActionItemAsPendingMutationError.md)
- [memberListQuery](variables/memberListQuery.md)
- [MOCKS](variables/MOCKS.md)
- [MOCKS\_ERROR](variables/MOCKS_ERROR.md)
- [updateActionItemMutation](variables/updateActionItemMutation.md)
