...
- [UnauthenticatedExtensions](type-aliases/UnauthenticatedExtensions.md)
- [UnauthorizedActionExtensions](type-aliases/UnauthorizedActionExtensions.md)
- [UnauthorizedActionOnArgumentsAssociatedResourcesExtensions](type-aliases/UnauthorizedActionOnArgumentsAssociatedResourcesExtensions.md)
- [UnauthorizedArgumentsExtensions](type-aliases/UnauthorizedArgumentsExtensions.md)
- [UnexpectedExtensions](type-aliases/UnexpectedExtensions.md)

## Variables

- [defaultTalawaGraphQLErrorMessages](variables/defaultTalawaGraphQLErrorMessages.md)
