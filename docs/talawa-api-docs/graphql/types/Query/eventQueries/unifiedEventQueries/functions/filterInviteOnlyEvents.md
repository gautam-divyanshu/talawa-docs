...
Defined in: [src/graphql/types/Query/eventQueries/unifiedEventQueries.ts:74](https://github.com/PalisadoesFoundation/talawa-api/blob/36d1ea832b10d1e9883eff7a03104362b71079bd/src/graphql/types/Query/eventQueries/unifiedEventQueries.ts#L74)
