...
# graphql/types/Plugin/inputs

## Variables

- [CreatePluginInput](variables/CreatePluginInput.md)
...
- [queryPluginsInputSchema](variables/queryPluginsInputSchema.md)
- [UpdatePluginInput](variables/UpdatePluginInput.md)
- [updatePluginInputSchema](variables/updatePluginInputSchema.md)
